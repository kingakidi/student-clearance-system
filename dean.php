        ...
        <div class="row">
            <div class="col-md-3  ">
                <div class="list-group list-group-flush" id="navbarNavDropdown">
                    <a href="deanpage.html" class="list-group-item active">
                        <i class="fas fa-tachometer-alt"></i>Dashboard
                    </a>
                    <a href="deanclearanceform.html" class="list-group-item list-group-item-action"><i
                    ...
                    <a href="#" class="list-group-item list-group-item-action"><i class="far fa-clipboard"></i>Students
                        Records </a>
                    <a href="aboutschool.html" htmlclass="list-group-item list-group-item-action"><i

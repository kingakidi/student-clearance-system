    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav  ml-auto">
                ...
                }else if($_SESSION['usertype'] != 'library'){
                    header("Location ./login.php");
                }
        ...
        <div class="row">
            <div class="col-md-3  ">
                <div class="list-group list-group-flush" id="navbarNavDropdown">
                    <a href="librarymain.html" class="list-group-item active">
                        <i class="fas fa-tachometer-alt"></i>Dashboard
                    </a>
                    <a href="studentsclearancepage.html" class="list-group-item list-group-item-action"><i
